...
//--- 
      ...
      double RVIGreenArray [];
      double RVIRedArray [];
      double RVIDefinition = iRVI(_Symbol,_Period,RVI_Period);
      ArraySetAsSeries(RVIGreenArray,true);
      ArraySetAsSeries(RVIRedArray,true);
      CopyBuffer(RVIDefinition,0,0,3,RVIGreenArray);
      CopyBuffer(RVIDefinition,1,0,3,RVIRedArray);
      double RVIGreenValue = RVIGreenArray[1];
      double RVIRedValue = RVIRedArray[1];
      
      if(RVIGreenValue > RVIRedValue && PositionsTotal() == 0)
      {
         isLong = true;
         int AskD = Ask / 0.5;
      ...
      else if(RVIGreenValue < RVIRedValue && PositionsTotal() == 0)
      {
         isLong = false;
         int BidD = Bid / 0.5;
      ...
      {
         if((isLong == true && RVIGreenValue < RVIRedValue) || (isLong == false && RVIGreenValue > RVIRedValue))
         {
            CloseBuySellSymbol();
         }
      }
